...
public class GullRoam : MonoBehaviour {
    ...
    void RotationOfFish()
    {
        if (isInArea == true)
        {
            transform.Rotate(Vector3.forward * Time.deltaTime * 30 * rotateDirection, Space.Self);
        }
        ...
        {
            transform.Rotate(Vector3.forward * Time.deltaTime * 40, Space.Self);
        }
    }
}
